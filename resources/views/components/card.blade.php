...
<div class="card flex flex-col h-full" style="min-height: 130px;">
    <div class="rounded-full p-2 w-auto md:dark:bg-opacity-60 justify-center items-center flex mx-auto" style="background-color: {{ $backgroundColors[$result->status] ?? $backgroundColors['default'] }}">
    ...
    <div class="w-full mt-4">
        <dd class="-mt-1 font-medium text-gray-900 dark:text-white md:mt-1 md:text-xl">
            {{ $result->label }}
        </dd>
        <dt class="mt-0 text-sm text-gray-600 dark:text-gray-300 md:mt-1 leading-loose">
    ...
    <div class="grow pt-2 flex flex-col justify-end">
        <span class="text-xs text-gray-500 italic">{{ $lastRanAt->diffForHumans() }}</span>
    </div>
</div>
