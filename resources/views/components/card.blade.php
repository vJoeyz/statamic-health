...
<div class="card flex flex-col h-full">
    <div class="w-full flex flex-row justify-between">
        <div>
            ...
            <dt class="mt-2 text-sm text-gray-600 dark:text-gray-300">
        ...
        <div class="rounded-full p-2 md:dark:bg-opacity-60 justify-center items-center flex aspect-square w-9 h-9" style="background-color: {{ $backgroundColors[$result->status] ?? $backgroundColors['default'] }}">
    ...
    <div class="grow mt-4 flex flex-col justify-end">
